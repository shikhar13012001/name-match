...
NICKNAMES = {
    ...
    'jb':'jeanbaptiste','ma':'marieanne',
    'mc':'marieclaire', 'pierrot':'pierre',
    'jeannot':'jean',   'mado':'madeleine','loulou':'louise',
}
...
def extract_features(payer, account):
    ...
    # CONFLICT DETECTION FIX (v2) -- checks ALL tokens not just first.
